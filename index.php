    ...
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <?php
         ...
         $myquery = "SELECT * FROM posts,users  where posts.UserID = users.UserID ORDER BY date DESC ";
         ...
         if($result = $conn->query($myquery)){
          ...
          <a href = "post.php?index=<?php printf("%d", $row["PostID"]) ?>"> <!--Sending index to post.php-->
          <img src="img/<?php printf("%s", $row["PostImage"]) ?>" style="width: 730px; height: 380px">
          <h3 class = "post-subtitle">
            <?php printf("%s", $row["Post"]);  ?>
           </h3>
          <p class="post-meta">Posted by
           <a href="about.php"><?php echo $row["Name"]; ?></a>
            on <?php printf($row["Date"]); ?></p> <!--converting timestamp to date-->
        <hr>
        <?php
         }
         }
